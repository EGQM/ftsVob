...
class CtaEngine(object):
    ...
    def __init__(self, mainEngine, eventEngine):
        ...
        self.registerEvent()
        self.loadSetting()
        self.initStrategy('double ema')
        self.startStrategy('double ema')
    ...
    def registerEvent(self):
        ...
        self.eventEngine.register(EVENT_CTA_LOG, self.print_log)
    ...
    def loadStrategy(self, setting):
        ...
        if name in self.strategyDict:
            ...
            if contract:
                ...
                self.writeCtaLog(self.mainEngine.subscribe(req, contract.gatewayName))
            else:
